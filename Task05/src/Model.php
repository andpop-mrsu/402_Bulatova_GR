...
use function GulyaBulatova\guessnumber\DataBase\insertNewGame;
use function GulyaBulatova\guessnumber\DataBase\addAttemptInDB;
use function GulyaBulatova\guessnumber\DataBase\outputListGame;
use function GulyaBulatova\guessnumber\DataBase\updateInfoGame;
use function GulyaBulatova\guessnumber\DataBase\outputListGameTop;
use function GulyaBulatova\guessnumber\DataBase\checkGameid;
...
function showGame($user_name)
{
    ...
    while ($attempt <= NUM_ATTEMPT) {
        ...
        while (is_numeric($get_num) === false) {
            echo "Некорректное число! " . PHP_EOL;
            $get_num = readline();
        }
